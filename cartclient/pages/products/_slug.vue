      ...
      <div class="columns">
        ...
        <div class="column is-half">
          <section class="section">
            ...
            <span class="tag is-rounded is-medium" v-if="!product.in_stock">
              Out of stock
            </span>
          ...
          <section class="section">
            <form  action="" @submit.prevent="add" method="post">
              ...
              <div class="control">
                <button type="submit" name="button is-info">Add to cart</button>
              </div>
            </form>
          </section>
        </div>
...
import {mapActions} from 'vuex'
  ...
  watch:{
    ...
    async asyncData ({params,app}){
      ...
      let response = await app.$axios.$get(`products/${slug}`)
